...
export class MusicControlComponent implements AfterViewInit {
  ...
  @Output() restart_music: EventEmitter<boolean> = new EventEmitter<boolean>();

  @Output() decrease_volume: EventEmitter<boolean> = new EventEmitter<boolean>();

  @Output() increase_volume: EventEmitter<boolean> = new EventEmitter<boolean>();
  ...
  ngAfterViewInit() {
    ...
    if (this.audioElement) {
      ...
      if (pauseBtn) pauseBtn.addEventListener('click', () => this.pauseMusic());

    }
  }

  public playMusic() { if (this.audioElement) this.audioElement.play(); }

  public pauseMusic() { if (this.audioElement) this.audioElement.pause(); }
